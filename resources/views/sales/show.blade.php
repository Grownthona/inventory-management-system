                        ...
                        <table class="table table-sm mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-{{ $line->account_type == 'asset' ? 'primary' : ($line->account_type == 'revenue' ? 'success' : ($line->account_type == 'expense' ? 'danger' : ($line->account_type == 'liability' ? 'warning text-dark' : 'secondary'))) }} bg-opacity-10 text-{{ $line->account_type == 'asset' ? 'primary' : ($line->account_type == 'revenue' ? 'success' : ($line->account_type == 'expense' ? 'danger' : ($line->account_type == 'liability' ? 'warning' : 'secondary'))) }} small">{{ $line->account_type }}</span></td>
